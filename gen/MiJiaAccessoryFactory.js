...
MiJiaAccessoryFactory.prototype.setTemperatureAndHumidity = function(gatewaySid, deviceSid, temperature, humidity) {
  // Temperature
...
// Motion sensor
MiJiaAccessoryFactory.prototype.setMotion = function(gatewaySid, deviceSid, motionDetected) {
...
// Contact sensor
MiJiaAccessoryFactory.prototype.setContact = function(gatewaySid, deviceSid, contacted) {
...
MiJiaAccessoryFactory.prototype.setWirelessSwitch = function(gatewaySid, deviceSid, status) {
  this.findServiceAndSetValue(
    gatewaySid,
    deviceSid,
