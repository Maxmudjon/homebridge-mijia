...
MiJiaAccessoryFactory.prototype.setTemperatureAndHumidity = function(gatewaySid, deviceSid, temperature, humidity, battery) {
  // Temperature
  isNaN(temperature) || this.findServiceAndSetValue(
    ...
    temperature,
    null); // No commander
  this.findServiceAndSetValueBattery(
    gatewaySid,
    deviceSid,
    UUIDGen.generate('Tem' + deviceSid),
    Accessory.Categories.SENSOR,
...
// Motion sensor
MiJiaAccessoryFactory.prototype.setMotion = function(gatewaySid, deviceSid, motionDetected, battery) {
...
// Contact sensor
MiJiaAccessoryFactory.prototype.setContact = function(gatewaySid, deviceSid, contacted, battery) {
...
MiJiaAccessoryFactory.prototype.setWirelessSwitch = function(gatewaySid, deviceSid, status, battery) {
  this.findServiceAndSetValue(
    gatewaySid,
    deviceSid,
 ...
 this.findServiceAndSetValueBattery(
    ...
    Service.BatteryService,
    Characteristic.StatusLowBattery,
    battery, //? Characteristic.StatusLowBattery.BATTERY_LEVEL_NORMAL = battery > "2801" : Characteristic.StatusLowBattery.BATTERY_LEVEL_LOW = (battery < "2801"),
    null); // No commander
...
//Add Battery Low Service and Update 
MiJiaAccessoryFactory.prototype.findServiceAndSetValueBattery = function(
  gatewaySid, deviceSid,
  accessoryUUID, accessoryCategory,
  serviceType,
  characteristicType, characteristicValue,
